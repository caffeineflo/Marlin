...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 185.61
  #define  DEFAULT_bedKi 36.55
  #define  DEFAULT_bedKd 235.68
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2500, 2500, 100, 250 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP      78.0  // (°C) Default bed temperature for the G26 Mesh Validation Tool.
  #endif
